...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"quanh năm\",            \"_word\": \"quanh nam\",            \"description\": \"Suốt từ đầu năm đến cuối năm.\",            \"tl\": \"Trạng từ\",            \"word_en\": \"all year round\",            \"tl_en\": \"Adverb\"        },        {            \"word\": \"đằng sau\",            \"_word\": \"dang sau\",            \"description\": \"\",            \"tl\": \"Trạng từ\",            \"word_en\": \"behind\",            \"tl_en\": \"Adverb\"        },        {            \"word\": \"đằng trước\",            \"_word\": \"dang truoc\",            \"description\": \"\",            \"tl\": \"Trạng từ\",            \"word_en\": \"in front\",            \"tl_en\": \"Adverb\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
