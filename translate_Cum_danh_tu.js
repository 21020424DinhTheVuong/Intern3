...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"rau diếp cá\",            \"_word\": \"rau diep ca\",            \"description\": \"\",            \"tl\": \"Cụm danh từ\",            \"word_en\": \"fish mint\",            \"tl_en\": \"Noun Phrase\"        },        {            \"word\": \"rằm trung thu\",            \"_word\": \"ram trung thu\",            \"description\": \"\",            \"tl\": \"Cụm danh từ\",            \"word_en\": \"Mid-Autumn Festival\",            \"tl_en\": \"Noun Phrase\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
