...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"cũng vậy/cũng thế\",            \"_word\": \"cung vay/cung the\",            \"description\": \"\",            \"tl\": \"Giới từ\",            \"word_en\": \"too/as well\",            \"tl_en\": \"Adverb\"        },        {            \"word\": \"cùng / với (giới từ)\",            \"_word\": \"cung / voi (gioi tu)\",            \"description\": \"\",            \"tl\": \"Giới từ\",            \"word_en\": \"with\",            \"tl_en\": \"Preposition\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
