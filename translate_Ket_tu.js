...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"nhưng\",            \"_word\": \"nhung\",            \"description\": \"Từ biểu thị điều sắp nêu ra ngược lại với điều vừa nói.\",            \"tl\": \"Kết từ\",            \"word_en\": \"but\",            \"tl_en\": \"Conjunction\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
