...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"mỗi ngày\",            \"_word\": \"moi ngay\",            \"description\": \"\",            \"tl\": \"Ngữ danh từ\",            \"word_en\": \"every day\",            \"tl_en\": \"Noun Phrase\"        },        {            \"word\": \"mồ hôi nhễ nhại\",            \"_word\": \"mo hoi nhe nhai\",            \"description\": \"\",            \"tl\": \"Ngữ danh từ\",            \"word_en\": \"sweating profusely\",            \"tl_en\": \"Noun Phrase\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
