...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"hoặc\",            \"_word\": \"hoac\",            \"description\": \"Từ biểu thị quan hệ giữa nhiều (thường là hai) khả năng khác nhau, không khả năng này thì khả năng kia, ít nhất có một khả năng được thực hiện.\",            \"tl\": \"Liên từ\",            \"word_en\": \"or\",            \"tl_en\": \"Conjunction\"        },        {            \"word\": \"hay là (hoặc là)\",            \"_word\": \"hay la (hoac la)\",            \"description\": \"Từ biểu thị điều sắp nêu ra là một khả năng mà người nói thấy chưa thể khẳng định, đang còn hồ nghi.\",            \"tl\": \"Liên từ\",            \"word_en\": \"or\",            \"tl_en\": \"Conjunction\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
