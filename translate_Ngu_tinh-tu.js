...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"ham chơi\",            \"_word\": \"ham choi\",            \"description\": \"\",            \"tl\": \"Ngữ tính từ\",            \"word_en\": \"playful\",            \"tl_en\": \"Adjective\"        },        {            \"word\": \"khó tiêu\",            \"_word\": \"kho tieu\",            \"description\": \"\",            \"tl\": \"Ngữ tính từ\",            \"word_en\": \"indigestible\",            \"tl_en\": \"Adjective\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
