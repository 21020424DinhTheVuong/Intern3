...
async function run() {
    const parts = [
        ...
        { text: "input: một danh sách dữ liệu json chứa các từ tiếng việt và các thông tin của nó {    \"data\": [        {            \"word\": \"suýt\",            \"_word\": \"suyt\",            \"description\": \"Chỉ còn thiếu chút nữa là đã xảy ra (thường là điều không hay).\",            \"tl\": \"Phụ từ\",            \"word_en\": \"almost\",            \"tl_en\": \"Adverb\"        },        {            \"word\": \"vẫn\",            \"_word\": \"van\",            \"description\": \"Từ biểu thị ý khẳng định về điều xảy ra, diễn ra như bình thường, cho dù điều kiện là không bình thường.\",            \"tl\": \"Phụ từ\",            \"word_en\": \"still\",            \"tl_en\": \"Adverb\"        }    ]}" },
        { text: "output: thêm trường \"synset_vi\" chứa các từ đồng nghĩa và cùng từ loại với từ trong trường \"word_en\", đồng thời chuyển các từ đó sang tiếng việt và bỏ trường \"word_en\" vaf \"tl_en\" " },
    ];
